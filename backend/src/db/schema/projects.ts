import {
  pgTable, uuid, varchar, text, boolean, timestamp, decimal, jsonb,
  date, integer, pgEnum, unique, primaryKey, index, AnyPgColumn,
...
export const projectViewEnum = pgEnum('project_view', ['list', 'table', 'board', 'gantt']);

export const budgetTypeEnum = pgEnum('budget_type', [
  'time', 'financial', 'fixed_fee', 'task_list', 'expense',
]);
...
export const projects = pgTable(
  'projects',
  {
    ...
    templateSourceId: uuid('template_source_id').references((): AnyPgColumn => projects.id, { onDelete: 'set null' }),
