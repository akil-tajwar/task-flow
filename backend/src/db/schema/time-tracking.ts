import { pgTable, uuid, varchar, text, boolean, timestamp, decimal, date, time, unique, index } from 'drizzle-orm/pg-core';
...
export const calendarEvents = pgTable(
  'calendar_events',
  {
    ...
    description: text('description'),
    eventType: varchar('event_type', { length: 30 }).notNull().default('meeting'),
